...
const ScrollBox = (props) => {
  ...
  useEffect(() => {
    ...
    if (document.getElementById("adminSubHeader")) {
      setAdminSubHeaderHeight(
        document.getElementById("adminSubHeader").offsetHeight
      );
    } else {
    ...
    <div
      style={{
        height:
          pageHeight -
          adminHeaderHeight -
          adminSubHeaderHeight -
          adminSubHeader2Height,
        overflowX: "hidden",
        overflowY: "auto",
        backgroundColor: "#fff",
      }}
    >
      {props.spacingTop && <div style={{ height: `${props.spacingTop}rem` }} />}
